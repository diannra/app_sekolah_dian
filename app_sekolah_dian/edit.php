    ...
    <body>
        ...
        <form action="?hal=edit" method="post">
            <table>
                ...
                <tr>
                    <td>NIS</td>
                    <td><input type="text" name="nis" placeholder="Nomor Induk Siswa" maxleght="20" value="<?=$baris['nis']?>"></td>
                </tr>
                <tr>
                    <td>NISN</td>
                    <td><input type="text" name="nisn" placeholder="Nomor Induk Siswa Nasional" maxleght="10" value="<?=$baris['nisn']?>"></td>
                </tr>
                <tr>
                    <td>Nama Siswa</td>
                    <td><input type="text" name="nama" placeholder="Nama Siswa" maxleght="50" value="<?=$baris['nama_siswa']?>"></td>
                </tr>
                <tr>
                    <td>Alamat</td>
